...
SEEDS=(38 39 40 41 42 43 44 45 46)
...
for SEED in "${SEEDS[@]}"; do
    ...
    TRAINED_SUBDIR="best_robertaIr${ROBERTA_LR}_elseIr${ELSE_LR}_hiddenDim${HIDDEN_DIM}_emotionDim${EMOTION_DIM}_pauseDim${PAUSE_DIM}_head${HEADS}_localWindowNum${LOCAL_WINDOW_NUM}_dropout${DROPOUT_RATE}_BaseLine"
